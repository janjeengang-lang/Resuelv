...
async function load(){
  try {
    const s = await chrome.storage.local.get(['aiProvider','openrouterApiKey','openrouterModel','geminiApiKey','cerebrasApiKey','ocrApiKey','ipdataApiKey','tempMailApiKey','typingSpeed','ocrLang']);

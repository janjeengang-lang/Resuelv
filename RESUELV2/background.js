    ...
    try {
      switch (message.type) {
        ...
        case 'GENERATE_PERSONA': {
          ...
          const p = `Create a fictional persona for survey qualification based on: "${prompt}". Respond ONLY with a JSON object containing fields: fullName, firstName, lastName, age, email, username, password, phone, address1, address2, city, state, zipCode, country, macAddress.`;

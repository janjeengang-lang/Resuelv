...
function init() {
  ...
  function ensureSurveyAgentStyles() {
    ...
    style.textContent = `
      #zepra-styled-modal .survey-agent-shell {
        max-width: 440px;
      }

      #zepra-styled-modal .survey-agent-panel {
        display: flex;
        flex-direction: column;
        gap: 1rem;
      }

      #zepra-styled-modal .survey-agent-status {
        display: flex;
        align-items: center;
        ...
        background: linear-gradient(135deg, rgba(15, 23, 42, 0.82), rgba(12, 18, 32, 0.75));
      }

      #zepra-styled-modal .survey-agent-status-left {
        display: flex;
        align-items: center;
        gap: 0.75rem;
      }

      #zepra-styled-modal .survey-agent-status-dot {
        width: 12px;
        height: 12px;
        border-radius: 999px;
      ...
      #zepra-styled-modal .survey-agent-status-dot.is-running {
        background: linear-gradient(130deg, #38bdf8, #22d3ee);
        box-shadow: 0 0 0 2px rgba(56, 189, 248, 0.22), 0 0 18px rgba(34, 211, 238, 0.6);
        animation: surveyAgentPulse 1.4s ease-in-out infinite;
      }

      #zepra-styled-modal .survey-agent-status-dot.is-success {
        background: linear-gradient(130deg, #22c55e, #4ade80);
        box-shadow: 0 0 0 2px rgba(34, 197, 94, 0.22), 0 0 16px rgba(74, 222, 128, 0.5);
      }

      #zepra-styled-modal .survey-agent-status-dot.is-warning {
        background: linear-gradient(130deg, #facc15, #f97316);
        box-shadow: 0 0 0 2px rgba(250, 204, 21, 0.22), 0 0 16px rgba(249, 115, 22, 0.45);
      }

      #zepra-styled-modal .survey-agent-status-dot.is-error {
        background: linear-gradient(130deg, #f87171, #ef4444);
        box-shadow: 0 0 0 2px rgba(248, 113, 113, 0.22), 0 0 16px rgba(239, 68, 68, 0.45);
      }
      ...
      #zepra-styled-modal .survey-agent-status-text {
        font-weight: 600;
      ...
      #zepra-styled-modal .survey-agent-status-meta {
        font-size: 0.75rem;
        color: #94a3b8;
      }

      #zepra-styled-modal .survey-agent-controls {
        display: flex;
        gap: 0.75rem;
      }

      #zepra-styled-modal .survey-agent-btn {
        flex: 1;
        border: none;
      ...
      #zepra-styled-modal .survey-agent-btn.start {
        background: linear-gradient(135deg, #22d3ee, #38bdf8);
        box-shadow: 0 14px 28px -18px rgba(56, 189, 248, 0.8);
      }

      #zepra-styled-modal .survey-agent-btn.stop {
        background: linear-gradient(135deg, #f87171, #ef4444);
        box-shadow: 0 14px 28px -18px rgba(248, 113, 113, 0.75);
        color: #fff;
      }

      #zepra-styled-modal .survey-agent-btn:disabled {
        cursor: not-allowed;
      ...
      #zepra-styled-modal .survey-agent-btn:not(:disabled):hover {
        transform: translateY(-1px);
        box-shadow: 0 20px 30px -18px rgba(56, 189, 248, 0.9);
      }

      #zepra-styled-modal .survey-agent-btn.stop:not(:disabled):hover {
        box-shadow: 0 20px 30px -18px rgba(248, 113, 113, 0.85);
      }

      #zepra-styled-modal .survey-agent-notes-wrap {
        display: flex;
        flex-direction: column;
        gap: 0.35rem;
      }

      #zepra-styled-modal .survey-agent-notes-wrap label {
        font-size: 0.75rem;
        text-transform: uppercase;
      ...
      #zepra-styled-modal .survey-agent-notes {
        width: 100%;
        min-height: 72px;
        resize: vertical;
        border-radius: 0.75rem;
        ...
        font-size: 0.85rem;
        line-height: 1.4;
        box-shadow: inset 0 0 12px rgba(8, 47, 73, 0.45);
      }

      #zepra-styled-modal .survey-agent-notes:focus {
        outline: none;
        border-color: rgba(56, 189, 248, 0.55);
        box-shadow: 0 0 0 2px rgba(56, 189, 248, 0.25);
      }

      #zepra-styled-modal .survey-agent-chat {
        border-radius: 1rem;
        border: 1px solid rgba(59, 130, 246, 0.18);
        background: linear-gradient(165deg, rgba(12, 18, 32, 0.9), rgba(8, 22, 39, 0.78));
        display: flex;
        flex-direction: column;
        overflow: hidden;
      }

      #zepra-styled-modal .survey-agent-chat-header {
        display: flex;
        flex-direction: column;
        gap: 0.3rem;
      ...
      #zepra-styled-modal .survey-agent-chat-header h4 {
        margin: 0;
        font-size: 0.85rem;
        letter-spacing: 0.08em;
        color: #bfdbfe;
      ...
      #zepra-styled-modal .survey-agent-chat-status {
        font-size: 0.75rem;
        color: rgba(226, 232, 240, 0.72);
      }

      #zepra-styled-modal .survey-agent-chat-body {
        max-height: 220px;
        overflow-y: auto;
      ...
      #zepra-styled-modal .survey-agent-chat-thread {
        display: flex;
        flex-direction: column;
        gap: 0.65rem;
      }

      #zepra-styled-modal .survey-agent-chat-empty {
        font-size: 0.8rem;
        color: #94a3b8;
        padding: 1rem;
        text-align: center;
      ...
      #zepra-styled-modal .survey-agent-chat-message {
        display: flex;
        gap: 0.5rem;
      }

      #zepra-styled-modal .survey-agent-chat-message.is-user {
        justify-content: flex-end;
      }

      #zepra-styled-modal .survey-agent-chat-message.is-system {
        justify-content: center;
      }

      #zepra-styled-modal .survey-agent-chat-bubble {
        max-width: 80%;
        padding: 0.55rem 0.75rem;
        border-radius: 0.85rem;
        font-size: 0.82rem;
        line-height: 1.4;
        box-shadow: 0 12px 24px -22px rgba(56, 189, 248, 0.8);
        position: relative;
      ...
      #zepra-styled-modal .survey-agent-chat-message.is-user .survey-agent-chat-bubble {
        background: linear-gradient(135deg, rgba(56, 189, 248, 0.82), rgba(14, 165, 233, 0.85));
        color: #0b1120;
        border-color: rgba(56, 189, 248, 0.55);
        box-shadow: 0 18px 30px -20px rgba(56, 189, 248, 0.75);
      }

      #zepra-styled-modal .survey-agent-chat-message.is-agent .survey-agent-chat-bubble {
        background: linear-gradient(135deg, rgba(59, 130, 246, 0.16), rgba(34, 197, 94, 0.16));
      }

      #zepra-styled-modal .survey-agent-chat-message[data-meta="error"] .survey-agent-chat-bubble {
        border-color: rgba(248, 113, 113, 0.65);
      }

      #zepra-styled-modal .survey-agent-chat-message.is-system .survey-agent-chat-bubble {
        background: rgba(30, 41, 59, 0.85);
        border-style: dashed;
        color: #cbd5f5;
      }

      #zepra-styled-modal .survey-agent-chat-timestamp {
        font-size: 0.68rem;
      ...
      #zepra-styled-modal .survey-agent-chat-compose {
        display: flex;
      ...
      #zepra-styled-modal .survey-agent-chat-input {
        flex: 1;
        min-height: 46px;
        border-radius: 0.75rem;
      ...
      #zepra-styled-modal .survey-agent-chat-input:focus {
        outline: none;
        border-color: rgba(56, 189, 248, 0.55);
        box-shadow: 0 0 0 2px rgba(56, 189, 248, 0.25);
      }

      #zepra-styled-modal .survey-agent-chat-send {
        border: none;
        border-radius: 0.75rem;
        ...
        background: linear-gradient(135deg, #22d3ee, #38bdf8);
        color: #0b1120;
        box-shadow: 0 12px 26px -18px rgba(56, 189, 248, 0.85);
        transition: transform 0.15s ease, box-shadow 0.15s ease, filter 0.15s ease;
      }

      #zepra-styled-modal .survey-agent-chat-send:hover {
        transform: translateY(-1px);
        box-shadow: 0 18px 32px -18px rgba(56, 189, 248, 0.9);
      }

      #zepra-styled-modal .survey-agent-chat-send:disabled {
        opacity: 0.6;
        cursor: not-allowed;
        box-shadow: none;
      ...
      #zepra-styled-modal .survey-agent-log {
        border-radius: 1rem;
        border: 1px solid rgba(59, 130, 246, 0.18);
        background: linear-gradient(165deg, rgba(12, 18, 32, 0.9), rgba(8, 22, 39, 0.78));
        overflow: hidden;
      ...
      #zepra-styled-modal .survey-agent-log-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
      ...
      #zepra-styled-modal .survey-agent-log-header h4 {
        margin: 0;
        font-size: 0.85rem;
        letter-spacing: 0.08em;
        color: #bfdbfe;
      ...
      #zepra-styled-modal .survey-agent-log-actions {
        display: flex;
        gap: 0.5rem;
      }

      #zepra-styled-modal .survey-agent-log-actions button {
      ...
      #zepra-styled-modal .survey-agent-log-actions button:hover:not(:disabled) {
        background: rgba(59, 130, 246, 0.22);
        border-color: rgba(59, 130, 246, 0.4);
        color: #fff;
      }

      #zepra-styled-modal .survey-agent-log-actions button:disabled {
        cursor: not-allowed;
        opacity: 0.55;
      }

      #zepra-styled-modal .survey-agent-log-body {
        max-height: 240px;
        overflow-y: auto;
        display: flex;
        flex-direction: column;
      ...
      #zepra-styled-modal .survey-agent-log-list {
        display: flex;
        flex-direction: column;
        gap: 0.75rem;
      }

      #zepra-styled-modal .survey-agent-log-empty {
        font-size: 0.8rem;
        color: #94a3b8;
        padding: 1.2rem;
        text-align: center;
      ...
      #zepra-styled-modal .survey-agent-log-item {
        border-radius: 0.85rem;
        background: linear-gradient(160deg, rgba(15, 23, 42, 0.85), rgba(17, 24, 39, 0.95));
        border-left: 3px solid rgba(59, 130, 246, 0.45);
        padding: 0.75rem 0.85rem;
        box-shadow: 0 18px 32px -30px rgba(56, 189, 248, 0.6);
      }

      #zepra-styled-modal .survey-agent-log-item.level-plan {
        border-left-color: rgba(56, 189, 248, 0.6);
      }

      #zepra-styled-modal .survey-agent-log-item.level-success {
        border-left-color: rgba(34, 197, 94, 0.65);
      }

      #zepra-styled-modal .survey-agent-log-item.level-error {
        border-left-color: rgba(248, 113, 113, 0.7);
      }

      #zepra-styled-modal .survey-agent-log-item.level-info {
        border-left-color: rgba(148, 163, 184, 0.55);
      }

      #zepra-styled-modal .survey-agent-log-item-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
        font-size: 0.72rem;
      ...
      #zepra-styled-modal .survey-agent-log-item-message {
        font-size: 0.9rem;
        font-weight: 600;
        color: #e2e8f0;
      }

      #zepra-styled-modal .survey-agent-log-item-detail {
        font-size: 0.75rem;
        color: #cbd5f5;
        margin-top: 0.3rem;
        opacity: 0.8;
      ...
      #zepra-styled-modal .survey-agent-status-dot.is-idle {
  ...
  function openSurveyAgentPanel() {
    ...
    const ui = getSurveyAgentUiState();
    if (ui.modal && ui.modal.isConnected) {
      updateSurveyAgentUiState();
      return ui.modal;
    }
    ...
    const modal = createStyledModal('Survey Agent', panelHtml, () => {
      const currentUi = getSurveyAgentUiState();
      if (currentUi.modal === modal) {
        currentUi.modal = null;
        currentUi.elements = null;
      }
    });

    const content = modal.querySelector('.styled-modal-content');
    if (content) content.classList.add('survey-agent-shell');

    ui.modal = modal;
    ui.elements = {
      statusDot: modal.querySelector('.survey-agent-status-dot'),
      statusText: modal.querySelector('.survey-agent-status-text'),
      statusMeta: modal.querySelector('.survey-agent-status-meta'),
      startBtn: modal.querySelector('.survey-agent-btn.start'),
      stopBtn: modal.querySelector('.survey-agent-btn.stop'),
      notesInput: modal.querySelector('.survey-agent-notes'),
      copyBtn: modal.querySelector('.survey-agent-copy'),
      clearBtn: modal.querySelector('.survey-agent-clear'),
      logList: modal.querySelector('.survey-agent-log-list'),
      logBody: modal.querySelector('.survey-agent-log-body'),
      emptyState: modal.querySelector('.survey-agent-log-empty'),
      chatBody: modal.querySelector('.survey-agent-chat-body'),
      chatThread: modal.querySelector('.survey-agent-chat-thread'),
      chatEmpty: modal.querySelector('.survey-agent-chat-empty'),
      chatInput: modal.querySelector('.survey-agent-chat-input'),
      chatSend: modal.querySelector('.survey-agent-chat-send'),
      chatForm: modal.querySelector('.survey-agent-chat-compose'),
      chatStatus: modal.querySelector('.survey-agent-chat-status'),
    };

...
function init() {
  ...
  function ensureSurveyAgentStyles() {
    ...
    style.textContent = `
      ...
      #zepra-survey-agent-panel .nano-agent-window {
        ...
        background: radial-gradient(circle at top, rgba(27, 82, 178, 0.38), rgba(2, 14, 32, 0.95)),
          linear-gradient(200deg, #061128 0%, #020714 100%);
        border-left: 1px solid rgba(80, 134, 255, 0.28);
      ...
      #zepra-survey-agent-panel .nano-agent-header {
        ...
        border-bottom: 1px solid rgba(94, 135, 214, 0.22);
        box-shadow: inset 0 -1px 0 rgba(4, 14, 32, 0.65);
      }
      ...
      #zepra-survey-agent-panel .nano-logo {
        ...
        height: 38px;
        border-radius: 13px;
        background: linear-gradient(135deg, #26d0ff, #2c6bff);
        color: #021431;
        font-size: 1.05rem;
        font-weight: 700;
        display: inline-flex;
        ...
        box-shadow: 0 18px 38px -24px rgba(44, 107, 255, 0.9);
      }
      ...
      #zepra-survey-agent-panel .nano-status-badge {
        ...
        border: 1px solid rgba(66, 138, 255, 0.42);
        background: rgba(32, 69, 146, 0.42);
        color: #9bc9ff;
        font-size: 0.74rem;
      ...
      #zepra-survey-agent-panel .nano-status-badge::before {
        ...
        box-shadow: 0 0 0 3px rgba(155, 201, 255, 0.22);
      }
      ...
      #zepra-survey-agent-panel .nano-run-toggle.is-stop {
        ...
        background: linear-gradient(135deg, rgba(248, 113, 113, 0.14), rgba(244, 63, 94, 0.22));
        color: #fda4af;
      }
      ...
      #zepra-survey-agent-panel .nano-avatar.is-user {
        background: rgba(17, 94, 166, 0.45);
        color: #9cc4ff;
      }

      #zepra-survey-agent-panel .nano-bubble {
        flex: 1;
        background: linear-gradient(145deg, rgba(9, 26, 58, 0.86), rgba(6, 18, 42, 0.95));
        border: 1px solid rgba(78, 134, 225, 0.36);
        border-radius: 1.1rem;
        padding: 0.85rem 1rem;
        color: #e5f1ff;
        line-height: 1.6;
        position: relative;
        box-shadow: 0 20px 38px -30px rgba(44, 107, 255, 0.65);
      }
      ...
      #zepra-survey-agent-panel .nano-message-meta {
        ...
        text-transform: uppercase;
        color: rgba(151, 189, 255, 0.6);
      }

      #zepra-survey-agent-panel .nano-compose {
        padding: 1.1rem 1.35rem 1.4rem;
        border-top: 1px solid rgba(70, 118, 212, 0.24);
        background: linear-gradient(180deg, rgba(5, 14, 30, 0.92), rgba(4, 10, 22, 0.97));
        display: flex;
        flex-direction: column;
        gap: 0.75rem;
      }
      ...
      #zepra-survey-agent-panel .nano-compose textarea {
        ...
        min-height: 64px;
        border-radius: 1rem;
        border: 1px solid rgba(78, 134, 225, 0.35);
      ...
      #zepra-survey-agent-panel .nano-compose textarea:focus {
        ...
        box-shadow: 0 0 0 1px rgba(59, 130, 246, 0.4), 0 18px 38px -32px rgba(59, 130, 246, 0.65);
      }
  ...
  function renderSurveyAgentChat() {
    ...
    chat.forEach((entry) => {
      ...
      avatar.textContent = role === 'agent' ? 'P' : 'U';
